...
class Material(object):
    ...
    def __init__(self, vertexSahderCode, fragmentShaderCode):

        self.programRef = OpenGLUtils.initializeProgram(vertexSahderCode, fragmentShaderCode)

        # Store Uniform objects in a dictionary, 
        ...
        # Additional uniforms can be added by extending this class.
