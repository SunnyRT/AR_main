...
class MatchMeshFactory(MeshFactory):
    def __init__(self, alpha=1, sceneObject=None, mediator=None):
        super().__init__(mediator)
        self.material = LineMaterial({"lineType": "segments", "lineWidth": 1, "alpha": alpha})
    ...
    def createMesh(self, matchPairs):
        ...
        geometry = MatchGeometry(matchPairs)
