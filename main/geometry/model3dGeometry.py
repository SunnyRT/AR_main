...
class Model3dGeometry(Geometry):
    def __init__(self, path):
        ...
        # Debugging vertex normal computation
        # o3d.io.write_triangle_mesh("D:/sunny/Codes/IIB_project/AR_main/test_ply/model3d_norm.ply", mesh)
        # print("model3d ply file with normals saved")
